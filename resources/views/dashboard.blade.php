        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            @if(!$hasData)
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-10 text-center">
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Welcome to Profit First! 🚀</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-8">You haven't run any analyses yet. Start your first
                        financial checkup now.</p>
            ...
            @else
                ...
                <div
                    ...
                    <div>
                        <h3 class="text-lg font-bold uppercase tracking-wider opacity-90">AI Financial Advisor</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border-l-4 border-blue-500">
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Revenue Analyzed</p>
                        <p class="text-3xl font-bold text-gray-900 dark:text-gray-100">
                            ${{ number_format($metrics['total_revenue']) }}</p>
                        <p class="text-xs text-gray-400 mt-1">Latest: ${{ number_format($metrics['latest_revenue']) }}</p>
                    </div>

                    <!-- Profit Margin Card -->
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border-l-4 border-green-500">
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Latest Profit Margin</p>
                        <p class="text-3xl font-bold text-gray-900 dark:text-gray-100">
                            {{ number_format($metrics['profit_margin'], 1) }}%</p>
                        <p class="text-xs text-gray-400 mt-1">Target: Varies by Industry</p>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4">Profit Trend (Actual vs Target)</h3>
                    <div class="h-80">
